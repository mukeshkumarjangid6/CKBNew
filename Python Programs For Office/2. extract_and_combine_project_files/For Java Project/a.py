...
ROOT_DIR = r"C:/Users/mujangid/eclipse-workspace/ExhibitMonitorApplication"    # <- change this
OUTPUT_FILE = r"C:/Users/mujangid/OneDrive - Capgemini/Desktop/Java-ExhibitMonitorApplication.txt"  # <- change this
TARGET_EXTENSIONS = {".java", ".xml", ".JAVA", ".XML", ".properties", ".jsp", "JSP", ".htm", "HTM", ".html", ".HTML", ".yml"}  # case-insensitive matching
APPEND_MODE = False
FOLLOW_LINKS = False
