...
ROOT_DIR = r"C:\Users\mujangid\OneDrive - Capgemini\Desktop\New folder\ANgularDemo4\employee-demo"    # <- change this
OUTPUT_FILE = r"C:/Users/mujangid/OneDrive - Capgemini/Desktop/employee-demo.txt"  # <- change this
TARGET_EXTENSIONS = {".cs",  ".CS", ".xml", ".XML", ".properties", ".sln", ".SLN", ".CSPROJ", ".csproj", ".yml", ".sln", ".http", ".json", ".props", ".targets", ".cshtml",".CSHTML", ".CSS", ".css", ".js",".JS",".dockerignore", "Dockerfile"}  # case-insensitive matching
APPEND_MODE = False
FOLLOW_LINKS = False
